...
Проверка:
![Image|695x418](https://github.com/sender2033/testwork-protech-Vafin/blob/main/Image/02_%D0%9B%D0%B0%D0%B1%D0%BE%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%202.%20VLAN-14.10.2025-00_37.png?raw=true)
...
switchport trunk allowed vlan 4,71,84,86
switchport nonegotiate
channel-group 1 mode active
no shutdown
exit
interface range e1/2
switchport trunk encapsulation dot1q
switchport mode trunk
switchport trunk native vlan 999
switchport trunk allowed vlan 4,71,84,86
...
Проверка:
![Image](https://github.com/sender2033/testwork-protech-Vafin/blob/main/Image/02_%D0%9B%D0%B0%D0%B1%D0%BE%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%202.%20VLAN-14.10.2025-02_13.png?raw=true)


Настройка маршрутизации 
```
Switch3_DSTR(config)#ip routing
Switch3_DSTR(config)#interface vlan 4
Switch3_DSTR(config-if)#ip address 10.10.4.1 255.255.255.0
Switch3_DSTR(config-if)#no shutdown
Switch3_DSTR(config-if)#exit
*Oct 13 23:19:01.471: %LINEPROTO-5-UPDOWN: Line protocol on Interface Vlan4, changed state to up
*Oct 13 23:19:02.471: %LINK-3-UPDOWN: Interface Vlan4, changed state to up
Switch3_DSTR(config-if)#exit
Switch3_DSTR(config)#interface vlan 71
Switch3_DSTR(config-if)#ip address 10.10.71.1 255.255.255.0
Switch3_DSTR(config-if)#no shutdown
Switch3_DSTR(config-if)#exit
Switch3_DSTR(config)#
*Oct 13 23:19:19.620: %LINEPROTO-5-UPDOWN: Line protocol on Interface Vlan71, changed state to up
*Oct 13 23:19:20.620: %LINK-3-UPDOWN: Interface Vlan71, changed state to up
Switch3_DSTR(config)#interface vlan 84
Switch3_DSTR(config-if)#ip address 10.10.84.1 255.255.255.240
Switch3_DSTR(config-if)#no shutdown
Switch3_DSTR(config-if)#exit
Switch3_DSTR(config)#
*Oct 13 23:19:28.010: %LINEPROTO-5-UPDOWN: Line protocol on Interface Vlan84, changed state to up
*Oct 13 23:19:29.017: %LINK-3-UPDOWN: Interface Vlan84, changed state to up
Switch3_DSTR(config)#interface vlan 86
Switch3_DSTR(config-if)#ip address 10.10.86.1 255.255.255.224
Switch3_DSTR(config-if)#no shutdown
Switch3_DSTR(config-if)#exit
Switch3_DSTR(config)#
*Oct 13 23:19:34.459: %LINEPROTO-5-UPDOWN: Line protocol on Interface Vlan86, changed state to up
*Oct 13 23:19:35.462: %LINK-3-UPDOWN: Interface Vlan86, changed state to up
Switch3_DSTR(config)#exit
```
Проверка
![Image](https://github.com/sender2033/testwork-protech-Vafin/blob/main/Image/02_%D0%9B%D0%B0%D0%B1%D0%BE%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%202.%20VLAN-14.10.2025-02_21.png?raw=true)


# Шаг 6 Проверка соединения vpc 3 и vpc 4
![Image](https://github.com/sender2033/testwork-protech-Vafin/blob/main/Image/02_%D0%9B%D0%B0%D0%B1%D0%BE%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%202.%20VLAN-14.10.2025-02_26.png?raw=true)
![Image](https://github.com/sender2033/testwork-protech-Vafin/blob/main/Image/02_%D0%9B%D0%B0%D0%B1%D0%BE%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%202.%20VLAN-14.10.2025-02_27.png?raw=true)
