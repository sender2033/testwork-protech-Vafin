...
Выполнение:
1. Следующим шагом после создания архива и `file2.txt` в предыдущем задании будет их сжатие. Следуя заданию, первой для сжатия будет использоваться утилита `gzip`. 